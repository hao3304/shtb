...
layui.define(["laytpl", "layer"], function(e) {
  ...
  (i.loading = function(e) {
    ...
    (i.req = function(e) {
      ...
      if (
        ((e.data = e.data || {}), (e.headers = e.headers || {}), n.tokenName)
      ) {
        var d = "string" == typeof e.data ? JSON.parse(e.data) : e.data;
        (e.data[n.tokenName] =
          n.tokenName in d
            ? e.data[n.tokenName]
            : layui.data(r.tableName)[n.tokenName] || ""),
          (e.headers[n.tokenName] =
            n.tokenName in e.headers
              ? e.headers[n.tokenName]
              : layui.data(r.tableName)[n.tokenName] || "");
      }
      return (
          ...
          error: function(e) {
            return (
              ...
              n.render.isError
                ...
                : (404 === e.status
                    ? n.render("template/tips/404")
                    : n.render("template/tips/error"),
