<template>
    <div class="wrapper" >
            ...
            <div slot="header">
                <x-filter ref="xFilter" :mode="mode" :list="filter" :width="160" @on-filter="onFilter" >
                    ...
                    <Tooltip content="新增" placement="bottom" style="margin-left: 20px;" slot="buttons" >
                        <Button type="primary" icon="md-add" @click="onAdd" style="padding: 5px 8px;margin-right: 10px" >
                            {{title}}
                        </Button>
                    </Tooltip>
        ...
        <Drawer
                ...
                class="f-drawer"
                :closable="false" >
            <div class="f-drawer__body" :style="{height: windowHeight - 105+ 'px'}" style="overflow-y: auto;padding: 16px">
