<template>
    <div>
        <div class="f-filter">
            <div v-if="list.length > 0" class="f-filter__prepend">
            ...
            <div v-if="list.length > 0" class="f-filter__content" :style="{width: width + 'px'}" >
            ...
            <div  class="f-filter__senior" v-show="toolbar" >
                ...
                <Tooltip v-show="mode!='simple'&&list.length > 1" content="高级搜索" placement="bottom" slot="right-block"  style="margin-right: 10px;"  >
                    <Button  @click="showSenior = !showSenior" icon="md-search" style="padding: 5px 8px;"></Button>
                </Tooltip>
